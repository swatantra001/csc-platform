...
// // ✨ This strictly forces the bot to only exist in the browser, hiding it from Webpack SSR
// const SemanticBot = dynamic(() => import("./SemanticBot"), { 
//   ssr: false 
// });
...
// /// ✨ Notice we renamed the incoming prop to `rawPost`
// export default function PostClient({ post: rawPost }: { post: DbPost }) {

// 	// ✨ SAFETY FIX: Intercept the DB data and guarantee all arrays AND text fields are valid 
//   // before React tries to render them!
//   const post = {
//     ...rawPost,
//     // 1. Array Fallbacks
...
//     // 2. String & Number Fallbacks for older legacy posts
...
// 			{/* ✨ ADD THE SEMANTIC BOT HERE ✨ */}
// 			<SemanticBot post={post} color={t.primary} />
// 		</>
// 	);
// }
	...
	return (
		<div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", background: T.pageBg, color: T.textPrimary, fontFamily: "'DM Sans', 'Noto Sans Devanagari', sans-serif", transition: "background .25s, color .25s" }}>
			...
			<div style={{ background: T.navBg, padding: "18px 0", marginTop: 10, textAlign: "center", color: "rgba(255,255,255,0.5)", fontSize: 12 }}>
				<p>© 2026 ShrilalCSC · All content sourced from official government notifications. For official information visit <a href="#" style={{ color: T.navBrandAccent, textDecoration: "none" }}>ssc.gov.in</a></p>
			</div>
